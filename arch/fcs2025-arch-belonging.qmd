...
# load functions
#source("O:/Projects/Faculty Survey/2025 Faculty Climate Survey/Project scripts/Survey functions 2025.R")
```
...
ggtrend(tr1, text = txt, pngname = "ARCH_Overall_YaleBelonging")
```
...
ggtrend(tr2, text = txt, pngname = "ARCH_byFacultyTrack_YaleBelonging")
```
...
ggtrend(tr3, text = txt, pngname = "ARCH_byRace_YaleBelonging")
```
...
ggtrend(tr4, text = txt, pngname = "ARCH_byGender_YaleBelonging")
```
...
ggtrend(tr5, text = txt, pngname = "ARCH_bySexualOrientation_YaleBelonging")
```
...
make_table(tr1, tr2, tr3, tr4, tr5, title = "ARCH_YaleBelonging")
```
...
```{r}
tr1 <- survey_trend(dat, question = "A2_agree_1", demographic = "Overall")
txt <- trend_descriptor2(tr1)
ggtrend(tr1, text = txt, pngname = "ARCH_Overall_UnitBelonging")
```

### By faculty track

```{r}
tr2 <- survey_trend(dat, question = "A2_agree_1", demographic = "Ladder")
txt <- trend_descriptor2(tr2)
ggtrend(tr2, text = txt, pngname = "ARCH_byFacultyTrack_UnitBelonging")
```

### By race/ethnicity

```{r}
tr3 <- survey_trend(dat, question = "A2_agree_1", demographic = "Race")
txt <- trend_descriptor2(tr3)
ggtrend(tr3, text = txt, pngname = "ARCH_byRace_UnitBelonging")
```
...
```{r}
tr4 <- survey_trend(dat, question = "A2_agree_1", demographic = "Gender")
txt <- trend_descriptor2(tr4)
ggtrend(tr4, text = txt, pngname = "ARCH_byGender_UnitBelonging")
```
...
```{r}
tr5 <- survey_trend(dat, question = "A2_agree_1", demographic = "LGBQA")
txt <- trend_descriptor2(tr5)
ggtrend(tr5, text = txt, pngname = "ARCH_bySexualOrientation_UnitBelonging", pointsize = 12)
```
