...
txt <- trend_descriptor2(tr1)
ggtrend(tr1, text = txt, pngname = "DRA_Overall_UnitBelonging")
```
...
txt <- trend_descriptor2(tr2)
ggtrend(tr2, text = txt, pngname = "DRA_byFacultyTrack_UnitBelonging")
```
...
txt <- trend_descriptor2(tr3)
ggtrend(tr3, text = txt, pngname = "DRA_byRace_UnitBelonging")
```
...
txt <- trend_descriptor2(tr4)
ggtrend(tr4, text = txt, pngname = "DRA_byGender_UnitBelonging")
```
...
txt <- trend_descriptor2(tr5)
ggtrend(tr5, text = txt, pngname = "DRA_bySexualOrientation_UnitBelonging", pointsize = 12)
```
