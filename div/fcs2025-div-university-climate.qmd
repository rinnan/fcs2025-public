...
ggtrend(tr1, text = txt, pngname = "DIV_Overall_YaleCommunity")
```
...
ggtrend(tr2, text = txt, pngname = "DIV_byFacultyTrack_YaleCommunity")
```
...
ggtrend(tr3, text = txt, pngname = "DIV_byRace_YaleCommunity")
```
...
ggtrend(tr4, text = txt, pngname = "DIV_byGender_YaleCommunity")
```
...
ggtrend(tr5, text = txt, pngname = "DIV_bySexualOrientation_YaleCommunity")
```
...
make_table(tr1, tr2, tr3, tr4, tr5, title = "DIV_YaleCommunity")
```
...
txt <- trend_descriptor2(tr1)
ggtrend(tr1, text = txt, pngname = "DIV_Overall_YalePromotion")
```
...
txt <- trend_descriptor2(tr2)
ggtrend(tr2, text = txt, pngname = "DIV_byFacultyTrack_YalePromotion")
```
...
txt <- trend_descriptor2(tr3)
ggtrend(tr3, text = txt, pngname = "DIV_byRace_YalePromotion")
```
...
txt <- trend_descriptor2(tr4)
ggtrend(tr4, text = txt, pngname = "DIV_byGender_YalePromotion")
```
...
txt <- trend_descriptor2(tr5)
ggtrend(tr5, text = txt, pngname = "DIV_bySexualOrientation_YalePromotion")
```
...
make_table(tr1, tr2, tr3, tr4, tr5, title = "DIV_YalePromotion")
```
