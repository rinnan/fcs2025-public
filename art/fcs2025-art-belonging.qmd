...
ggtrend(tr1, text = txt, pngname = "ART_Overall_YaleBelonging")
```
...
ggtrend(tr2, text = txt, pngname = "ART_byFacultyTrack_YaleBelonging")
```
...
ggtrend(tr3, text = txt, pngname = "ART_byRace_YaleBelonging")
```
...
ggtrend(tr4, text = txt, pngname = "ART_byGender_YaleBelonging")
```
...
ggtrend(tr5, text = txt, pngname = "ART_bySexualOrientation_YaleBelonging")
```
...
make_table(tr1, tr2, tr3, tr4, tr5, title = "ART_YaleBelonging")
```
...
txt <- trend_descriptor2(tr1)
ggtrend(tr1, text = txt, pngname = "ART_Overall_UnitBelonging")
```
...
txt <- trend_descriptor2(tr2)
ggtrend(tr2, text = txt, pngname = "ART_byFacultyTrack_UnitBelonging")
```
...
txt <- trend_descriptor2(tr3)
ggtrend(tr3, text = txt, pngname = "ART_byRace_UnitBelonging")
```
...
txt <- trend_descriptor2(tr4)
ggtrend(tr4, text = txt, pngname = "ART_byGender_UnitBelonging")
```
...
txt <- trend_descriptor2(tr5)
ggtrend(tr5, text = txt, pngname = "ART_bySexualOrientation_UnitBelonging", pointsize = 12)
```
